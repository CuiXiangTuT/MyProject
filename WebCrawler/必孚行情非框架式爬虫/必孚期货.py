...
def getReportListFunc():
    ...
    data = {"MessageID": "447caa34-2c12-449b-8694-d27c640525ea", "MessageType": 3000000003,
...
def getData():
    ...
    for i in range(len(reportIDList)):
        item = {}
        ...
        if i == len(reportIDList) - 1:
            data = {"MessageID": "27c93245-250b-4e5a-a912-e0a0a47a3ad7", "MessageType": 3000000001,
                    "Data": {"UserID": "danaodaiyangyang", "ReportID": reportIDList[i], "PreReportID": i,
                             "OriginPlace": "全部",
                             "Part": "全部", "FeedingMode": ""}}
        else:
            data = {"MessageID": "27c93245-250b-4e5a-a912-e0a0a47a3ad7", "MessageType": 3000000001,
                    "Data": {"UserID": "danaodaiyangyang", "ReportID": reportIDList[i],
                             "PreReportID": reportIDList[i + 1],
                             "OriginPlace": "全部",
                             "Part": "全部", "FeedingMode": ""}}
        randomIp = random.choice(ipList)
        ...
        for perData in dataList:
            ...
            detailData = {"MessageID": str(uuid.uuid4()), "MessageType": 3000000004,
                          "Data": {"UserID": "danaodaiyangyang", "Part": perData['Part'],
                                   "Country": perData['OriginPlace'], "RecommendDay": 0,
                                   "FeedingMode": perData['FeedingMode'], "Type": "_futures", "IsFirst": True,
                                   "IsEn": False}}
            randomIp = random.choice(ipList)
            ...
            # 将三组数据进行打包处理
            zipData = list(zip(dateList, riseList, priceList))
