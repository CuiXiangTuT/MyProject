...
redis_dict_key = 'ods_weixin_gongzhonghao_aigenongye'
...
def getImgUrl():
    ...
    files = {'file': ('aigenongye.jpg', open('./imgFile/aigenongye.png', 'rb'))}
...
def getDetailData(url):
    ...
    # 内容
    sectionList = response.xpath('//div[@id="js_content"]//span|//div[@id="js_content"]//img')
    cokk = {}
    for sectionIndex in range(len(sectionList)):
        ...
        try:
            if 'img' in sectionStr and 'class="mp-video-player"' not in sectionStr:
                ...
                # 写入到本地
                f = open('./imgFile/aigenongye.png', 'wb')
...
def getListData():
    ...
    data = {
        ...
        'account': 'Cnagri_',
        'nonce': '72938b6f5',
        'xyz': '3162928d2893f43079507c57d6d5acf3',
