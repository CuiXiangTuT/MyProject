...
redis_dict_key = 'ods_weixin_gongzhonghao_yangniuxinxiku'
...
def getImgUrl(img_name):
    ...
    files = {'file': (img_name+'.jpg', open('./imgFile/yangniuxinxiku/'+img_name+'.png', 'rb'))}
...
def getDetailData(url):
    ...
    for i in sectionList:
        if 'http' in i:
            ...
            f = open('./imgFile/yangniuxinxiku/'+img_name+'.png', 'wb')
...
def getListData():
    ...
    data = {
        ...
        'account': 'yangniuxinxiku',
        'nonce': 'c065ad9b1',
        'xyz': 'a129a17818d29ba53478f74bf5d41573',
