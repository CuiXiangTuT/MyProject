...
redis_dict_key = 'ods_weixin_gongzhonghao_baxinanmeiqiaobao'
...
def getImgUrl():
    ...
    files = {'file': ('aodaliyadiyichanye.jpg', open('./imgFile/aodaliyadiyichanye.png', 'rb'))}
...
def getDetailData(url):
    ...
    # 内容
    sectionList = response.xpath('//div[@id="js_content"]//p')
    cokk = {}
    for sectionIndex in range(len(sectionList)):
        ...
        try:
            if 'img' in sectionStr and 'class="mp-video-player"' not in sectionStr:
                ...
                # 写入到本地
                f = open('./imgFile/aodaliyadiyichanye.png', 'wb')
...
def getListData():
    ...
    data = {
        ...
        'account': 'brnmqb',
        'nonce': '0cbe1935d',
        'xyz': 'e06002301a35103de2de2c7e2cfa1a9e',
