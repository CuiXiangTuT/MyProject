...
redis_dict_key = 'ods_weixin_gongzhonghao_guojixumuwang'
...
def getImgUrl(img_name):
    ...
    files = {'file': (img_name+'.jpg', open('./imgFile/guojixumuwang/'+img_name+'.png', 'rb'))}
...
def getDetailData(url):
    ...
    for i in sectionList:
        if 'http' in i:
            ...
            # 写入到本地
            f = open('./imgFile/guojixumuwang/'+img_name+'.png', 'wb')
