...
redis_dict_key = 'ods_weixin_gongzhonghao_xiandaiyangye'
...
def getImgUrl():
    ...
    files = {'file': ('xiandaiyangye.jpg', open('./imgFile/xiandaiyangye.png', 'rb'))}
...
def getDetailData(url):
    ...
    for i in sectionList:
        if 'http' in i:
            ...
            # 写入到本地
            f = open('./imgFile/xiandaiyangye.png', 'wb')
...
def getListData():
    ...
    data = {
        ...
        'account': 'gh_e10416672e40',
        'nonce': '4b72f0951',
        'xyz': 'dd5750cb4d8c93937409d06f8b23d749',
