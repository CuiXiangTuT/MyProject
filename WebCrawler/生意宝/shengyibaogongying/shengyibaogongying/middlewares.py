...
class ShengyibaogongyingSpiderMiddleware:
...
class ShengyibaogongyingDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class HttpbinProxyMiddleware(object):
    ...
    def __init__(self):
        ...
        :param settings:
        """
        # self.xdl_url = 'http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=193f9bddb3fe4dd9bc98ef673f3f9cb9&orderno=YZ202110193100GSiXz6&returnType=2&count=1'
