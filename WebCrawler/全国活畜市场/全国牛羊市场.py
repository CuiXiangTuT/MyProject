...
def saveData(result):
    ...
    file_market = open('./全国牛羊市场/全国牛羊市场.txt', 'a+', encoding='utf-8')
            ...
            if item['area_market_count'] == '0':
                ...
                for eve_pois in pois_list:
                    ...
                    if tel:
                        ...
                        item['tel'] = '无'
                    # biz_ext
                    item['biz_ext'] = str(eve_pois['biz_ext'])
                    ...
                    if len(photos_list):
                        ...
                        sheet.write(row_num, 13, item['biz_ext'])
                        row_num += 1
                        file_name = './全国餐饮市场' + '-' + str(eve_data['pois'][0]['pname']) + '-' + str(
                        ...
                        file_name = './全国牛羊市场/全国牛羊市场' + '-' + str(eve_data['pois'][0]['pname']) + '-' + str(
                            result.index(eve_data)) + '.xlsx'
                        work_book.save(file_name)
    file_market.close()
