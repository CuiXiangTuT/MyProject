...
class ZhongguonongyebushujuchaxundadouPipeline:
    ...
    def open_spider(self, spider):
        ...
        self.redis_data_dict = 'ods_chinancnybsjcxdd'  # 自定义
        # 链接MySQL数据库
    ...
    def process_item(self, item, spider):
        ...
        if self.redis_db.hexists(self.redis_data_dict,
            ...
            # 进行MySQL入库处理
            sql = "insert into ods_chinanongcunnongyebusjcxdd(Carea,Csource,CindexName,Ctime,product,itemName,itemType,area,Cperiod,unit,Cvalue,insertTime) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
